<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">List of Attribute Staff</h4> </div>
...
$(document).ready(function() {
        ...
        $.ajax({
        url: 'get_attribute_staff_count.php',
        type: 'POST',
    ...
    $('#demo-foo-pagination').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url':'attribute_staffajax.php?chkp=<?php echo $_GET['chkp'];?>'
        },
        'columns': [
    ...
    $(document).on("click",".delete",function(){
        ...
        swal({   
            ...
            closeOnConfirm: false 
                ...
                url: 'conf_delete.php',
                type: 'POST',
                data: { log_id:mid, cmdType:"delattrstaffSingle"}, // it will serialize the form data
                    dataType: 'html'
                })
                .done(function(data){
