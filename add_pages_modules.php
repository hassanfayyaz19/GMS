...
$sqlmoduleD=$db->record_select($sqlmodule);
$mod_name=$sqlmoduleD[0]['mod_name'];
...
$rstRow=$db->record_select($q);

$mid=$rstRow[0]['mod_id'];
$mname=$rstRow[0]['mod_name'];
$mdes=$rstRow[0]['mod_des'];
$ms=$rstRow[0]['mod_status'];
...
$selFun='getlink(this,"get_links");';
?>
<script language="javascript" src="js/get_mod_pages.js"></script>
<!-- RIBBON -->
<div id="ribbon">
                ...
                <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form class="smart-form" action="attach_pages_act.php?purl=<?php echo $_REQUEST['chkp']?>" method="post" enctype="multipart/form-data">    
                                ...
                                <fieldset>
                                    <div class="row">
                                        <section class="col col-6">
                                            ...
                                            <label class="input">
                                                <?php //echo $Form->selectList('select_module', $selFun, 'tblmodules', '', '', 'mod_id', '', '', 'textfield','mod_name', '+ + + Select Module First + + +'); ?>
                                                <?php 	
                                    ...
                                    <div class="row">
                                        <section class="col col-6">
                                            <label class="label">Attach Modules</label>
                                            <label class="input">
                                                <?php //echo $Form->selectList('select_link[]', '', 'tbllinks', '', '', 'link_id', '', '5', 'textfield_m','link_name',''); ?>
                                                <?php 	
													$sList="<select name='select_link[]' id='select_link[]' class='textfield' size='5'  multiple>";
													$sql ="SELECT * FROM tbllinks order by link_id ";
													$result=$db->record_select($sql);
													foreach($result as $code) {
													$sList .= "<option value=\"".$code['link_id']."\" >".ucwords(strtolower($code['link_name']))."</option>";
													}
													$sList .="</select>"; 
													echo $sList;
												?>
