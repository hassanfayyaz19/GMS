																...
																<tbody>
																   ...
																   ?>   
																	...
																	<tr class="rowTextCenter" id="row0ofsize0" style="position:fix;">
                                                                        ...
                                                                        <td>
                                <select relqty="<?php echo $newQty;?>" reluom="<?php echo $sqlItemD[0]['uom_id'];?>" relasid="<?php echo $sqlsizeD['assignment_size_id'];?>" reli="<?php echo $i;?>" class="select2 m-b-10 select2-multiple selectedstock" name="stocks[]" multiple="multiple" data-placeholder="Choose">
                                    <?php
									if($sqlItemD[0]['uom_id']==4 || $sqlItemD[0]['uom_id']==7)
									{
										$sqlstockItems="SELECT * FROM tbl_stock_items,tbl_stock_item_rolls WHERE tbl_stock_items.stock_item_id=tbl_stock_item_rolls.stock_item_id AND tbl_stock_items.item_id=".$sqlMaterialD['item_id']."";
									...
									{
										$sqlstockItems="SELECT * FROM tbl_stock_items WHERE tbl_stock_items.item_id=".$sqlMaterialD['item_id']." AND stock_quantity<>0";
										$sqlstockItemsQ=$db->record_select($sqlstockItems);
										foreach($sqlstockItemsQ as $sqlstockItemsD)
										{
										?>
									...
									?>
                                                                        ...
                                                                        <td><input class="form-control" id="total_<?php echo $sqlsizeD['assignment_size_id'];?>_<?php echo $i;?><?php //echo $sqlsizeD['assignment_size_id'];?>" name="total[]" readonly /></td>
                                                                        <td><input class="form-control" id="remaining_<?php echo $sqlsizeD['assignment_size_id'];?>_<?php echo $i;?><?php //echo $sqlsizeD['assignment_size_id'];?>" name="remaining[]" readonly /></td>
																	</tr>
																	<?php $i++;}?>
																</tbody>
															</table>
