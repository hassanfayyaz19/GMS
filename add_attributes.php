...
{
	$mid=$_GET['mid'];
	$sqleventId="SELECT * FROM tbl_attribute WHERE attribute_id=$mid";
...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title"><?php echo $pagetitle;?> Attributes</h4> </div>
    ...
    <?php }?>
    	<a href="index_admin.php?chkp=395&m=131" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">ALL ATTRIBUTES</a>
...
<!--.row-->
<form action="conf_add_attributes.php?chkp=<?php echo $_GET['chkp'];?>&m=<?php echo $_GET['m'];?>" id="form1" method="post" enctype="multipart/form-data">
        ...
        <div class="white-box">
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body">
                        <div class="form-body">
                            <h3 class="box-title">Attribute's Information</h3>
                            <hr>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputuname">Attribute</label>
                                        <div class="input-group">
                                        	<div class="input-group-addon"><i class="fa fa-pencil-square-o"></i></div>
                                            <input type="text" class="form-control" name="attribute" id="attribute" value="<?php echo $attribute;?>" placeholder="Attribute Label">
                                        </div>
                                         <span id="error_attribute" class="text-danger"></span>
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                        	<?php echo $GeneralFunctions->getStatus("attribute_status", $attribute_status);?>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
	...
	$(document).ready(function() {
        ...
        if($('#attribute').val() == '')
        {
            error_attribute = 'Attribute label is Required';
            $('#error_attribute').text(error_attribute);
            $('#attribute').css('border-color', '#cc0000');
        }
        else
        {
            error_attribute = '';
            $('#error_attribute').text(error_attribute);
            $('#attribute').css('border-color', '');
        }
