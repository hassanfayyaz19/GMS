...
<?php
$stockQuery = "SELECT * FROM tbl_joborder,`tbl_joborder_size_attribute` WHERE tbl_joborder.joborder_id=tbl_joborder_size_attribute.joborder_id AND tbl_joborder.client_id=$log_id AND tbl_joborder.is_complete=1 GROUP BY tbl_joborder.client_id";
...
<div class="col-md-12">
    ...
    <?php
$stockQuery1 = "SELECT * FROM tbl_joborder,`tbl_joborder_size_attribute` WHERE tbl_joborder.joborder_id=tbl_joborder_size_attribute.joborder_id AND tbl_joborder.client_id=$log_id AND tbl_joborder.is_complete=0 GROUP BY tbl_joborder.client_id";
