...
{
	$mid=$_GET['mid'];
	$sqleventId="SELECT * FROM tbl_location WHERE location_id=$mid";
...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title"><?php echo $pagetitle;?> Location</h4> </div>
    ...
    <?php }?>
    	<a href="index_admin.php?chkp=374&m=123" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">ALL LOCATION</a>
...
<!--.row-->
<form action="conf_add_location.php?chkp=<?php echo $_GET['chkp'];?>&m=<?php echo $_GET['m'];?>" id="form1" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputuname">Location</label>
                                        <div class="input-group">
                                        	<div class="input-group-addon"><i class="fa fa-pencil-square-o"></i></div>
                                            <input type="text" class="form-control" name="location" id="location" value="<?php echo $location;?>" placeholder="location">
                                        </div>
                             ...
                             <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                        	<?php echo $GeneralFunctions->getStatus("location_status", $location_status);?>
                                        </div>
                                    </div>
                                </div>
                            </div>
