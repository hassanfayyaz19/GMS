                ...
                <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form class="smart-form" action="links_act.php?purl=<?php echo $_REQUEST['chkp']?>" method="post" enctype="multipart/form-data">    
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <section class="col col-6">
                                            ...
                                            <label class="input">
                                                <input type="text" name="txtfile" value="<?php echo $txtfile;?>" />
                                            </label>
                                        </section>
    								</div>
                                    <div class="row">
                                        <section class="col col-6">
                                            <label class="label">Font Code</label>
                                            <label class="input">
                                                <input type="text" name="link_font" value="<?php echo $link_font;?>" />
                                            </label>
                                        </section>
    								</div>
                                    <div class="row">
                                        <section class="col col-6">
                                            ...
                                            <label class="input">
                                                <input type="text" name="Epic" value="<?php echo $mname;?>" />
                                            </label>
                                        </section>
    								</div>
                                    <div class="row">
                                        <section class="col col-2">
                                            <div class="inline-group">
                                                <label class="toggle">
                                                <input type="checkbox" name="show_p"  value="Y" <?php if($ms=="Y") echo 'checked=""'; elseif($ms=="N") echo '';?>>
                                                <i data-swchon-text="YES" data-swchoff-text="NO"></i>Show Pages</label>
                                            </div>
                                        </section>
    								</div>
                                 </fieldset>
