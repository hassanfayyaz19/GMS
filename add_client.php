...
<!--.row-->
<form action="conf_add_client.php?chkp=<?php echo $_GET['chkp'];?>&m=<?php echo $_GET['m'];?>" id="form1" method="post" enctype="multipart/form-data">
...
<script>
	...
	$(document).ready(function() {
       ...
       if($('#user_first_name').val()!='' && $('#user_email').val()!='' && $('#office_tel').val()!='')
       {
      $("#form1").submit();
       }
    });
