...
{
	$mid=$_GET['mid'];
	$sqleventId="SELECT * FROM tbl_size WHERE size_id=$mid";
...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title"><?php echo $pagetitle;?> Size</h4> </div>
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
    <?php
	if($_GET['cmdType']=="edit"){
	?>
    	<a href="index_admin.php?chkp=378&m=123" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">ADD SIZE</a>
    <?php }?>
    	<a href="index_admin.php?chkp=375&m=123" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">ALL SIZE</a>
...
<!--.row-->
<form action="conf_add_size.php?chkp=<?php echo $_GET['chkp'];?>&m=<?php echo $_GET['m'];?>" id="form1" method="post" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="size" id="size" value="<?php echo $size;?>" placeholder="Size">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputuname">Size Short</label>
                                        <div class="input-group">
                                        	<div class="input-group-addon"><i class="fa fa-pencil-square-o"></i></div>
                                            <input type="text" class="form-control" name="size_short" id="size_short" value="<?php echo $size_short;?>" placeholder="Size Short">
                                        </div>
                                        <span id="error_size_short" class="text-danger"></span>
                                    </div>
                                </div>
                            </div>
                             <div class="row">
...
<script>
	...
	$(document).ready(function() {
        ...
        if($('#size_short').val() == '')
        {
            error_size_short = 'Size Short is Required';
            $('#error_size_short').text(error_size_short);
            $('#size_short').css('border-color', '#cc0000');
        }
        else
        {
            error_size_short = '';
            $('#error_size_short').text(error_size_short);
            $('#size_short').css('border-color', '');
        }
        
       if($('#size').val()!='' && $('#size_short').val()!='')
       {
      $("#form1").submit();
       }
    });
