                                        ...
                                        <table class="form-table customFields" id="customFields" width="100%">
                                          <tr>
                                           ...
                                           <tr valign="top">
                                                ...
                                                <td><input class="form-control" id="firstquantity0" name="firstquantity0" disabled="disabled" data-validate="required" placeholder="">
                                                ...
                                                <input class="form-control" id="secondquantity0" name="secondquantity0" disabled="disabled" readonly="readonly" data-validate="required" placeholder="">
...
$(document).on("change",".itemName",function(){
	...
	.done(function(data){
		...
		if(newuomval!=1)
		{
			$("#position"+x).prop('disabled', true);
			$("#secondquantity"+x).prop('disabled', true);
			$("#firstquantity"+x).prop('disabled', false);
		}
		else
		{
			$("#position"+x).prop('disabled', false);
			$("#secondquantity"+x).prop('disabled', true);
			$("#firstquantity"+x).prop('disabled', true);
		}
