...
{
	$sqlinsert="INSERT INTO tbl_size (size, size_short, size_status) VALUES ('$size', '$size_short', '$size_status')";
	$size_id=$db->record_insert($sqlinsert);
	if($size_id>0)
	{
...
else	// if Account edit
{
	...
	$sqlinsert="UPDATE tbl_size SET size='$size', size_short='$size_short', size_status='$size_status' WHERE size_id=$mid";
